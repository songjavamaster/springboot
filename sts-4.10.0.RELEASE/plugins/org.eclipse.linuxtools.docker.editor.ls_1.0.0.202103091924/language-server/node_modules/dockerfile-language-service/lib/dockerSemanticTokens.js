(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "vscode-languageserver-protocol", "dockerfile-ast", "vscode-languageserver-types", "./docker"], factory);
    }
    ...
    var TokensLegend = /** @class */ (function () {
        ...
        TokensLegend.init = function () {
            this.tokenTypes[vscode_languageserver_protocol_1.SemanticTokenTypes.keyword] = 0;
            this.tokenTypes[vscode_languageserver_protocol_1.SemanticTokenTypes.comment] = 1;
            this.tokenTypes[vscode_languageserver_protocol_1.SemanticTokenTypes.parameter] = 2;
            this.tokenTypes[vscode_languageserver_protocol_1.SemanticTokenTypes.property] = 3;
            this.tokenTypes[vscode_languageserver_protocol_1.SemanticTokenTypes.namespace] = 4;
            this.tokenTypes[vscode_languageserver_protocol_1.SemanticTokenTypes.class] = 5;
            this.tokenTypes[vscode_languageserver_protocol_1.SemanticTokenTypes.macro] = 6;
            this.tokenTypes[vscode_languageserver_protocol_1.SemanticTokenTypes.string] = 7;
            this.tokenTypes[vscode_languageserver_protocol_1.SemanticTokenTypes.variable] = 8;
            this.tokenTypes[vscode_languageserver_protocol_1.SemanticTokenTypes.operator] = 9;
            this.tokenModifiers[vscode_languageserver_protocol_1.SemanticTokenModifiers.declaration] = 1;
            this.tokenModifiers[vscode_languageserver_protocol_1.SemanticTokenModifiers.definition] = 2;
            this.tokenModifiers[vscode_languageserver_protocol_1.SemanticTokenModifiers.deprecated] = 4;
        };
    ...
    var DockerSemanticTokens = /** @class */ (function () {
        ...
        DockerSemanticTokens.prototype.computeSemanticTokens = function () {
            ...
            for (var _a = 0, _b = this.dockerfile.getDirectives(); _a < _b.length; _a++) {
                ...
                this.createToken(null, prefixRange, vscode_languageserver_protocol_1.SemanticTokenTypes.comment, [], false);
                this.createToken(null, nameRange, vscode_languageserver_protocol_1.SemanticTokenTypes.property, [], false);
                ...
                this.createToken(null, operatorRange, vscode_languageserver_protocol_1.SemanticTokenTypes.operator, [], false);
                if (valueRange.start.character !== valueRange.end.character) {
                    this.createToken(null, valueRange, vscode_languageserver_protocol_1.SemanticTokenTypes.parameter, [], false);
                }
            }
            for (var i = 0; i < lines.length; i++) {
                if (lines[i] instanceof dockerfile_ast_1.Comment) {
                    var range = lines[i].getRange();
                    this.createToken(null, range, vscode_languageserver_protocol_1.SemanticTokenTypes.comment, [], false);
                }
                else {
        ...
        DockerSemanticTokens.prototype.createTokensForInstruction = function (instruction) {
            ...
            if (instruction.getKeyword() === dockerfile_ast_1.Keyword.MAINTAINER) {
                modifiers = [vscode_languageserver_protocol_1.SemanticTokenModifiers.deprecated];
            }
            this.createToken(instruction, instructionRange, vscode_languageserver_protocol_1.SemanticTokenTypes.keyword, modifiers);
            if (instruction instanceof dockerfile_ast_1.ModifiableInstruction) {
                for (var _i = 0, _a = instruction.getFlags(); _i < _a.length; _i++) {
                    ...
                    this.createToken(instruction, mergedRange, vscode_languageserver_protocol_1.SemanticTokenTypes.parameter);
                    ...
                    if (flagValue !== null) {
                        if (flag.hasOptions()) {
                            ...
                            this.createToken(instruction, operatorRange, vscode_languageserver_protocol_1.SemanticTokenTypes.operator, [], false, false);
                            for (var _b = 0, _c = flag.getOptions(); _b < _c.length; _b++) {
                                var option = _c[_b];
                                nameRange = option.getNameRange();
                                this.createToken(instruction, nameRange, vscode_languageserver_protocol_1.SemanticTokenTypes.parameter);
                                ...
                                if (valueRange !== null) {
                                    ...
                                    this.createToken(instruction, operatorRange_1, vscode_languageserver_protocol_1.SemanticTokenTypes.operator, [], false, false);
                                    if (option.getValue() !== "") {
                                        this.createToken(instruction, valueRange, vscode_languageserver_protocol_1.SemanticTokenTypes.property);
                                    }
                                }
                            }
                        }
            ...
            switch (instruction.getKeyword()) {
                ...
                case dockerfile_ast_1.Keyword.ENV:
                    ...
                    for (var _d = 0, _e = propertyInstruction.getProperties(); _d < _e.length; _d++) {
                        ...
                        this.createToken(instruction, nameRange_1, vscode_languageserver_protocol_1.SemanticTokenTypes.variable, [vscode_languageserver_protocol_1.SemanticTokenModifiers.declaration], false);
                        ...
                        if (valueRange !== null) {
                            ...
                            this.createToken(instruction, valueRange, vscode_languageserver_protocol_1.SemanticTokenTypes.parameter, [], true, true);
                        }
                    }
                    return;
                case dockerfile_ast_1.Keyword.FROM:
                    ...
                    if (nameRange !== null) {
                        this.createToken(instruction, nameRange, vscode_languageserver_protocol_1.SemanticTokenTypes.class);
                    }
                    var tagRange = from.getImageTagRange();
                    if (tagRange !== null) {
                        this.createToken(instruction, tagRange, vscode_languageserver_protocol_1.SemanticTokenTypes.property);
                    }
                    var digestRange = from.getImageDigestRange();
                    if (digestRange !== null) {
                        this.createToken(instruction, digestRange, vscode_languageserver_protocol_1.SemanticTokenTypes.property);
                    }
                    ...
                    if (fromArgs.length > 1) {
                        if (fromArgs[1].getValue().toUpperCase() === "AS") {
                            ...
                            this.createToken(instruction, range_1, vscode_languageserver_protocol_1.SemanticTokenTypes.keyword);
                            if (fromArgs.length > 2) {
                                this.createToken(instruction, fromArgs[2].getRange(), vscode_languageserver_protocol_1.SemanticTokenTypes.namespace);
                ...
                case dockerfile_ast_1.Keyword.HEALTHCHECK:
                    ...
                    if (subcommand !== null) {
                        ...
                        this.createToken(instruction, range_2, vscode_languageserver_protocol_1.SemanticTokenTypes.keyword);
                        if (args.length > 1) {
        ...
        DockerSemanticTokens.prototype.createArgumentTokens = function (instruction, args) {
            ...
            for (var i = 0; i < args.length; i++) {
                ...
                this.createToken(instruction, args[i].getRange(), vscode_languageserver_protocol_1.SemanticTokenTypes.parameter, [], true, true);
            }
            if (lastRange !== null) {
                ...
                switch (this.content.charAt(i)) {
                    ...
                    case '\n':
                        if (comment !== -1) {
                            ...
                            this.createToken(null, commentRange, vscode_languageserver_protocol_1.SemanticTokenTypes.comment, [], false);
                            comment = -1;
                        }
                        break;
                    case '#':
        ...
        DockerSemanticTokens.prototype.createEscapeToken = function (instruction, offset) {
            ...
            this.createToken(instruction, escapeRange, vscode_languageserver_protocol_1.SemanticTokenTypes.macro, [], false, false, false);
        };
        DockerSemanticTokens.prototype.createToken = function (instruction, range, tokenType, tokenModifiers, checkVariables, checkStrings, checkNewline) {
            ...
            if (checkStrings) {
                            ...
                            if (next === '\'' || next === '"') {
                                if (this.quote === null) {
                                    if (this.escapedQuote === null) {
                                        ...
                                        this.createToken(instruction, quoteRange, vscode_languageserver_protocol_1.SemanticTokenTypes.string, [], true, false);
                                        newOffset = i + 2;
                                        this.escapedQuote = null;
                                    }
                                }
                ...
                if (this.quote !== null) {
                    ...
                    tokenType = vscode_languageserver_protocol_1.SemanticTokenTypes.string;
                                ...
                                commentCheck: for (var j = i + 1; j < endOffset; j++) {
                                    switch (this.content.charAt(j)) {
                                        ...
                                        case '\r':
                                            ...
                                            this.createToken(null, crComment, vscode_languageserver_protocol_1.SemanticTokenTypes.comment, [], false);
                                            i = j + 1;
                                            startOffset = -1;
                                            break commentCheck;
                                        case '\n':
                                            ...
                                            this.createToken(null, lfComment, vscode_languageserver_protocol_1.SemanticTokenTypes.comment, [], false);
                                            i = j;
                                            startOffset = -1;
                                            break commentCheck;
                                    }
            ...
            if (checkVariables) {
                ...
                for (var _i = 0, _a = instruction.getVariables(); _i < _a.length; _i++) {
                    ...
                    if (docker_1.Util.isInsideRange(variableRange.start, range)) {
                        ...
                        this.createToken(instruction, variableRange, vscode_languageserver_protocol_1.SemanticTokenTypes.variable, [], false);
